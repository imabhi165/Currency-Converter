...
const Footer = () => {
  return (
    <footer className="w-full py-4 bg-white border-t border-gray-200 text-center mt-8">
      <div className="flex justify-center items-center gap-2">
        <span className="text-gray-600 text-base">Made with <span className="text-red-500">❤️</span> by <span className="font-bold text-indigo-600">Abhi!</span></span>
        <a href="https://github.com/imabhi165" target="_blank" rel="noopener noreferrer" className="ml-2 text-gray-400 hover:text-indigo-500 transition">
